...
enum sign { NAS, N1, N2, N3, N4, N5, N6, N7, N8, N9, PLUS, STOP, CD, TAKI, PLUSTWO }; //enumartion of signs. NAS - is not avaiable sign
class Card {
	color clr;
	sign s;
public:
	...
	bool is_leggal(const Card& other_card, const sign cs) const; //check if other card is leggal on this card. if same color or sign retrun true, else return false.
